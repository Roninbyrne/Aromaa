...
BOT_USERNAME = getenv("BOT_USERNAME", "Shanaya_singing_bot")
...
OWNER_ID = int(getenv("OWNER_ID", 6879651909))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/arona_update")
